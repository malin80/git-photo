...
- (UIView *)datePickerView {
    if (!_datePickerView) {
        ...
        UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(20, 10, 42, 20)];
        ...
        UIButton *okButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 52, 10, 42, 20)];
...
- (void)calendarItem:(FDCalendarItem *)item didSelectedDate:(NSDate *)date {
    ...
    [self.daili showData:[format stringFromDate:date]];
}
