...
@interface CeremonyWomenViewController () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation CeremonyWomenViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return GET_SINGLETON_FOR_CLASS(CeremonyManager).ceremonyWomenInfos.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CeremonyInfo *info = [GET_SINGLETON_FOR_CLASS(CeremonyManager).ceremonyWomenInfos objectAtIndex:indexPath.row];
